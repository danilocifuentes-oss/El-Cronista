...
Arriba, igual que abajo: el mismo umbral húmedo te llama.`,
      options: [
        {
          id: "ch1m_sire_echo_a",
          type: "dialogue",
          text: "Subir hasta la puerta y escuchar mejor",
          requirement: { type: "none" },
          nextSceneId: "ch1m_7",
          effects: [{ type: "setFlag", flag: "mal_sire_to_door" }],
        },
      ],
    },
    {
      ...
      options: [
        {
          id: "ch1m_6_a",
          type: "dialogue",
          text: "Acercarte al umbral y escuchar hasta que ganen definición",
          requirement: { type: "none" },
          nextSceneId: "ch1m_7",
          effects: [{ type: "setFlag", flag: "mal_1_6_listen" }],
        },
      ],
    },
    {
      id: "ch1m_7",
      chapterId: "chapter01",
      title: "1.7 · Las voces del otro lado",
      text: `Las voces al otro lado de la puerta se vuelven más claras. Una mujer habla en círculos perfectos, un hombre repite la misma frase sin parar ("ellos ya vienen, ellos ya vienen"), y alguien llora suavemente, como si supiera que ya está muerto.`,
      options: [
        {
          id: "ch1m_7_a",
          type: "dialogue",
          text: "Abrir la puerta de golpe con dramatismo teatral",
          requirement: { type: "none" },
          nextSceneId: "ch1m_8",
          effects: [{ type: "hungerDelta", delta: 1 }, { type: "setFlag", flag: "mal_1_7_dramatic" }],
        },
        {
          id: "ch1m_7_b",
          type: "dialogue",
          text: "Responder a las voces con un acertijo propio",
          requirement: { type: "none" },
          nextSceneId: "ch1m_9",
          effects: [{ type: "setFlag", flag: "mal_1_7_riddle" }],
        },
        {
          id: "ch1m_7_c",
          type: "discipline",
          discipline: "auspex",
          disciplineTitle: "Ver a través del umbral cerrado",
          text: "Usar Auspex para ver a través de la madera",
    ...
    },
    {
      id: "ch1m_8",
      chapterId: "chapter01",
      title: "1.8 · El teatro de los locos",
      text: `Abres la puerta con un floreo. Del otro lado hay una mujer vestida de negro y dos hombres. Todos te miran como si ya te conocieran. La habitación huele a incienso y sangre vieja.`,
      options: [
        {
          id: "ch1m_8_a",
          type: "dialogue",
          text: "Hacer una reverencia dramática y presentarte",
          requirement: { type: "none" },
          nextSceneId: "ch1m_11",
          effects: [{ type: "setFlag", flag: "mal_1_8_bow" }],
        },
        {
          id: "ch1m_8_b",
          type: "dialogue",
          text: "Decir la primera locura que te venga a la mente",
          requirement: { type: "none" },
          nextSceneId: "ch1m_12",
          effects: [{ type: "hungerDelta", delta: 2 }, { type: "setFlag", flag: "mal_1_8_blurt" }],
        },
      ],
    },
    {
      id: "ch1m_9",
      chapterId: "chapter01",
      title: "1.9 · El acertijo",
      text: `Respondes a las voces con un acertijo. El silencio que sigue es tan profundo que puedes oír cómo crecen las grietas en las paredes.`,
      options: [
        {
          id: "ch1m_9_a",
          type: "dialogue",
          text: "Esperar pacientemente su respuesta",
          requirement: { type: "none" },
          nextSceneId: "ch1m_11",
          effects: [{ type: "setFlag", flag: "mal_1_9_wait" }],
        },
        {
          id: "ch1m_9_b",
          type: "dialogue",
          text: "Reírte porque ya sabes la respuesta",
          requirement: { type: "none" },
          nextSceneId: "ch1m_12",
          effects: [{ type: "hungerDelta", delta: 1 }, { type: "setFlag", flag: "mal_1_9_laugh_known" }],
        },
      ],
    },
    {
      id: "ch1m_10",
      chapterId: "chapter01",
      title: "1.10 · Visión a través de la puerta",
      text: `Tu Auspex traspasa la madera. Ves tres auras retorcidas: ambición, miedo y una locura que compite con la tuya. Sabes que uno de ellos es tu sire.`,
      options: [
        {
          id: "ch1m_10_a",
          type: "dialogue",
          text: "Entrar con confianza, como si ya supieras todo",
          requirement: { type: "none" },
          nextSceneId: "ch1m_11",
          effects: [{ type: "setFlag", flag: "mal_1_10_enter" }],
        },
      ],
    },
    {
      id: "ch1m_11",
      chapterId: "chapter01",
      title: "1.11 · La revelación fragmentada",
      text: `La mujer te mira con ojos brillantes y te dice: "Eres Malkavian. Los que vemos lo que otros no pueden. La ciudad está rota y tú eres una de las grietas. Bienvenido al lado correcto del espejo."`,
      options: [
        {
          id: "ch1m_11_a",
          type: "dialogue",
          text: "Aceptar tu nueva realidad con una sonrisa torcida",
          requirement: { type: "none" },
          nextSceneId: "ch1m_13",
          effects: [{ type: "setFlag", flag: "mal_1_11_accept_twist" }],
        },
        {
          id: "ch1m_11_b",
          type: "dialogue",
          text: "Hacer una pregunta que ni siquiera tú entiendes",
          requirement: { type: "none" },
          nextSceneId: "ch1m_14",
          effects: [{ type: "hungerDelta", delta: 1 }, { type: "setFlag", flag: "mal_1_11_riddle_who" }],
        },
      ],
    },
    {
      id: "ch1m_12",
      chapterId: "chapter01",
      title: "1.12 · La risa final",
      text: `Todo encaja y se rompe al mismo tiempo. Te ríes. La mujer ríe contigo. El mundo entero parece reírse de un chiste que solo comparten tu risa y la suya.`,
      options: [
        {
          id: "ch1m_12_a",
          type: "dialogue",
          text: "Salir a la lluvia riéndote",
          requirement: { type: "none" },
          nextSceneId: "ch1m_14",
          effects: [{ type: "hungerDelta", delta: 2 }, { type: "setFlag", flag: "mal_1_12_rain_laugh" }],
        },
      ],
    },
    {
      id: "ch1m_13",
      chapterId: "chapter01",
      title: "1.13 · El final poético",
      text: `Sales a la lluvia de Santiago. Las luces de neón bailan como mariposas rotas. Todo tiene sentido. Nada tiene sentido.

Y por primera vez te sientes perfectamente en casa.
...
Fin del Capítulo 1.`,
    ...
    },
    {
      id: "ch1m_14",
      chapterId: "chapter01",
      title: "1.14 · El espejo roto",
      text: `La realidad se agrieta. Sales a la calle riendo tan fuerte que la gente se aparta de ti. Sabes que nunca volverás a estar solo… porque ahora ellos también te escuchan.
      ...
      options: [
        {
          ...
          effects: [
            { type: "hungerDelta", delta: 3 },
            { type: "setFlag", flag: "chapter01_malkavian_chaotic_end" },
            { type: "setFlag", flag: "chapter02_pending" },
          ],
        },
      ],
